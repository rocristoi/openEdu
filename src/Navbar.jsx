    ...
    useEffect(() => {
      ...
      if(isMobile) {
        return (
          ...
          style={{
            backgroundColor: hasScrolledPast ? 'rgb(0, 0, 0)' : 'transparent', 
          }}
          transition={{
          ...
          <div className="flex flex-row items-center">
              ...
              />
                      ...
                      <div className="text-amber-50 flex flex-row justify-center items-center gap-10 ">
                         <a href="/register"> <motion.button className='h-10 w-24 bg-green-500 flex flex-row justify-center items-center rounded-full'
          ...
          <div className="flex flex-row items-center">
              ...
              />
                      ...
                      <div className="text-green-500 flex flex-row justify-center items-center gap-10 ">
                         <a href="/dashboard"> <motion.button className='h-10 w-48 bg-transparent border border-green-500 flex flex-row justify-center items-center rounded-full'
                          whileHover={{scale: 1.05}}
                          whileTap={{scale: 0.99}}
                          >
                      ...
                      <div className="text-amber-50 flex flex-row justify-center items-center gap-10 ">
                         <a href="/register"> <motion.button className='h-10 w-36 bg-green-500 flex flex-row justify-center items-center rounded-full'
                          whileHover={{scale: 1.05}}
                          whileTap={{scale: 0.99}}
                          >
